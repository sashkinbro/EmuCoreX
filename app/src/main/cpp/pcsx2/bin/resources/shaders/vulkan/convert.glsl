...
{
	vec4 value = sample_c(v_tex);
	o_col0 = vec4(vec3(gpu_bitwise_and(uvec3(value.rgb * 65535.5f), uvec3(255u))) / 255.0f, value.a);
}
#endif
...
void ps_convert_float16_rgb5a1()
{
	...
	uint d = uint(sample_c(v_tex).r * exp2(32.0f));
	o_col0 = vec4(gpu_bitwise_and(uvec4(d << 3, d >> 2, d >> 7, d >> 8), uvec4(0xf8, 0xf8, 0xf8, 0x80))) / 255.0f;
}
#endif
