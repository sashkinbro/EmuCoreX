...
static constexpr int VU_HOST_XMMT2 = 1;
static constexpr int VU_HOST_XMMPQ = 15;
static constexpr int VU_HOST_XMMSCRATCH = 30;

static constexpr int VU_HOST_T1 = 0;
static constexpr int VU_HOST_T2 = 1;
static constexpr int VU_HOST_F0 = 3;
