...
#include "Config.h"
#include "R5900.h"
#include "R5900_Profiler-arm64.h"
#include "VU.h"
...
namespace R5900
{
	namespace Dynarec
	{
		extern void recDoBranchImmOaknut(u32 branchTo, oaknut::Cond skipCond, bool isLikely = false, bool swappedDelaySlot = false);
	} // namespace Dynarec
} // namespace R5900
...
void _eeMoveGPRtoR(int to, int fromgpr, bool allow_preload = true);
