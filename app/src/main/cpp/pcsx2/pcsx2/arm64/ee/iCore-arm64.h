...
////////////////////////////////////////////////////////////////////////////////
// Shared Register allocation flags (apply to ARM64 host GPR/vector registers).
...
////////////////////////////////////////////////////////////////////////////////
//   ARM64 Host Register Allocation Tools
...
#define EEINST_XMM    0x20 // var will be used in ARM64 vector ops
...
static __fi bool EEINST_XMM_USEDTEST(u32 reg)
{
...
#define FLUSH_ALL_X86          0x020 // flush ARM64 host GPRs
#define FLUSH_FREE_TEMP_X86    0x040 // flush and free temporary ARM64 host GPRs
#define FLUSH_FREE_NONTEMP_X86 0x080 // free all ARM64 host GPRs, except temporary
