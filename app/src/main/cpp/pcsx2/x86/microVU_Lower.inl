...
{
	armAsm->Fmul(PQ.S(), Fs.S(), armLoadPtrV(PTR_RUNTIME(mVUglob.T1)).S());
	armAsm->Fcvt(PQ.V1D(), PQ.S());
	armAsm->Fcvt(Fs.V1D(), Fs.S());
	armAsm->Mov(t2.V16B(), Fs.V16B());

	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmadd(PQ.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_ATAN_D[1])).V1D(), PQ.V1D());
	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmadd(PQ.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_ATAN_D[2])).V1D(), PQ.V1D());
	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmadd(PQ.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_ATAN_D[3])).V1D(), PQ.V1D());
	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmadd(PQ.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_ATAN_D[4])).V1D(), PQ.V1D());
	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmadd(PQ.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_ATAN_D[5])).V1D(), PQ.V1D());
	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmadd(PQ.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_ATAN_D[6])).V1D(), PQ.V1D());
	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
	armAsm->Fmadd(PQ.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_ATAN_D[7])).V1D(), PQ.V1D());
	armAsm->Fcvt(PQ.S(), PQ.V1D());
	armAsm->Fadd(PQ.S(), PQ.S(), armLoadPtrV(PTR_RUNTIME(mVUglob.Pi4)).S());
	mVU_EFUArm64SanitizeScalar(PQ);
}
...
mVUop(mVU_EATAN)
{
	...
	pass2
	{
		const xmm& src = mVU.regAlloc->allocReg(_Fs_, 0, (1 << (3 - _Fsf_)));
...
//		xPSHUF.D(xmmPQ, xmmPQ, mVUinfo.writeP ? 0x27 : 0xC6); // Flip xmmPQ to get Valid P instance
        ...
        armAsm->Mov(Fs.S(), 0, src.S(), 0);
		mVU_EFUArm64SanitizeScalar(Fs);
...
mVUop(mVU_EATANxy)
{
	...
	pass2
	{
		const xmm& src = mVU.regAlloc->allocReg(_Fs_, 0, 0xf);
		const xmm& Fs = mVU.regAlloc->allocReg();
		const xmm& t1 = mVU.regAlloc->allocReg();
		const xmm& t2 = mVU.regAlloc->allocReg();
//		xPSHUF.D(xmmPQ, xmmPQ, mVUinfo.writeP ? 0x27 : 0xC6); // Flip xmmPQ to get Valid P instance
		...
		armAsm->Mov(t1.S(), 0, src.S(), 0);
		armAsm->Ins(Fs.V4S(), 0, src.V4S(), 1);
		mVU_EFUArm64SanitizeScalar(t1);
		mVU_EFUArm64SanitizeScalar(Fs);
		a64::Label end;
		armAsm->Fcmp(t1.S(), 0.0);
...
//		xPSHUF.D(xmmPQ, xmmPQ, mVUinfo.writeP ? 0x27 : 0xC6); // Flip xmmPQ to get Valid P instance
		...
		armAsm->Ldr(t2.S(), PTR_RUNTIME(mVUglob.E1));
		armAsm->Fmadd(xmmPQ.S(), Fs.S(), t2.S(), t1.S());
		armAsm->Fcvt(xmmPQ.V1D(), xmmPQ.S());
		armAsm->Fcvt(Fs.V1D(), Fs.S());
		armAsm->Mov(t2.V16B(), Fs.V16B());

		armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
		armAsm->Fmadd(xmmPQ.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_EXP_D[2])).V1D(), xmmPQ.V1D());
		armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
		armAsm->Fmadd(xmmPQ.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_EXP_D[3])).V1D(), xmmPQ.V1D());
		armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
		armAsm->Fmadd(xmmPQ.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_EXP_D[4])).V1D(), xmmPQ.V1D());
		armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
		armAsm->Fmadd(xmmPQ.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_EXP_D[5])).V1D(), xmmPQ.V1D());
		armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
		armAsm->Fmadd(xmmPQ.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_EXP_D[6])).V1D(), xmmPQ.V1D());

		armAsm->Fcvt(xmmPQ.S(), xmmPQ.V1D());
		armAsm->Fcvt(xmmPQ.V1D(), xmmPQ.S());
		armAsm->Fmul(xmmPQ.V1D(), xmmPQ.V1D(), xmmPQ.V1D());
		armAsm->Fmul(xmmPQ.V1D(), xmmPQ.V1D(), xmmPQ.V1D());
		armAsm->Fcvt(xmmPQ.S(), xmmPQ.V1D());
...
//		xPSHUF.D      (xmmPQ, xmmPQ, mVUinfo.writeP ? 0x27 : 0xC6); // Flip xmmPQ to get Valid P instance
		...
		mVU_EFUArm64SanitizeScalar(Fs);
		armAsm->Fcvt(Fs.V1D(), Fs.S());
		armAsm->Fmul(xmmPQ.V1D(), Fs.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_SIN_D[0])).V1D());
		armAsm->Mov(t2.V16B(), Fs.V16B());

		armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
		armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
		armAsm->Fmul(t1.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_SIN_D[1])).V1D());
		armAsm->Fadd(xmmPQ.V1D(), xmmPQ.V1D(), t1.V1D());
		armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
		armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
		armAsm->Fmul(t1.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_SIN_D[2])).V1D());
		armAsm->Fadd(xmmPQ.V1D(), xmmPQ.V1D(), t1.V1D());
		armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
		armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
		armAsm->Fmul(t1.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_SIN_D[3])).V1D());
		armAsm->Fadd(xmmPQ.V1D(), xmmPQ.V1D(), t1.V1D());
		armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
		armAsm->Fmul(t2.V1D(), t2.V1D(), Fs.V1D());
		armAsm->Fmul(t1.V1D(), t2.V1D(), armLoadPtrV(PTR_RUNTIME(mVUglob.EFU_SIN_D[4])).V1D());
		armAsm->Fadd(xmmPQ.V1D(), xmmPQ.V1D(), t1.V1D());
		armAsm->Fcvt(xmmPQ.S(), xmmPQ.V1D());
		mVU_EFUArm64SanitizeScalar(xmmPQ);
//		xPSHUF.D      (xmmPQ, xmmPQ, mVUinfo.writeP ? 0x27 : 0xC6); // Flip back
...
//            xMOV(ptr32[Rmem], 0x3f800000);
            armAsm->Mov(a64::WRegister(EAX), 0x3f800000);
            armAsm->Str(a64::WRegister(EAX), PTR_CPU(vuRegs[mVU.index].VI[REG_R].UL));
        }
...
//		xMOVZX(regT, ptr16[&mVU.getVifRegs().top]);
		...
		{
			armMoveAddressToReg(RXVIXLSCRATCH, mVU.index ? static_cast<const void*>(&vif1Regs.top) : static_cast<const void*>(&vif0Regs.top));
			armAsm->Ldrh(regT, a64::MemOperand(RXVIXLSCRATCH));
		}
		mVU.regAlloc->clearNeeded(regT);
...
//		xMOVZX(regT, ptr16[&mVU.getVifRegs().itop]);
		...
		{
			armMoveAddressToReg(RXVIXLSCRATCH, mVU.index ? static_cast<const void*>(&vif1Regs.itop) : static_cast<const void*>(&vif0Regs.itop));
			armAsm->Ldrh(regT, a64::MemOperand(RXVIXLSCRATCH));
		}
...
//	xTEST(ptr32[&VU1.xgkickenable], 0x1);
    armAsm->Ldr(a64::WRegister(EAX), PTR_CPU(vuRegs[1].xgkickenable));
    armAsm->Tst(EAX, 0x1);
...
//	xCMP(ptr32[&VU1.xgkickcyclecount], 2);
    armAsm->Ldr(a64::WRegister(EAX), PTR_CPU(vuRegs[1].xgkickcyclecount));
    armAsm->Cmp(EAX, 2);
...
//	xFastCall(mVU_XGKICK_, ptr32[&mVU.VIxgkick]);
    armAsm->Ldr(a64::WRegister(EAX), PTR_MVU(microVU[mVU.index].VIxgkick));
...
//			xMOV(ptr32[&VU1.xgkicksizeremaining], 0);
            armAsm->Str(a64::wzr, PTR_CPU(vuRegs[1].xgkicksizeremaining));
//			xMOV(ptr32[&VU1.xgkickcyclecount], 0);
            armAsm->Str(a64::wzr, PTR_CPU(vuRegs[1].xgkickcyclecount));
//			xMOV(gprT2, ptr32[&mVU.totalCycles]);
            armAsm->Ldr(gprT2, PTR_MVU(microVU[mVU.index].totalCycles));
//			xSUB(gprT2, ptr32[&mVU.cycles]);
            armAsm->Sub(gprT2q, gprT2q, armLoadPtr(PTR_MVU(microVU[mVU.index].cycles)));
//			xADD(gprT2, ptr32[&VU1.cycle]);
            armAsm->Add(gprT2q, gprT2q, armLoad64(PTR_CPU(vuRegs[1].cycle)));
//			xMOV(ptr32[&VU1.xgkicklastcycle], gprT2);
            armAsm->Str(gprT2q, PTR_CPU(vuRegs[1].xgkicklastcycle));
//			xMOV(gprT1, regS);
...
//		xMOV(ptr32[&mVU.branch], gprT1);
        armAsm->Str(a64::WRegister(gprT1), PTR_MVU(microVU[mVU.index].branch));
...
//			xMOV(ptr32[&mVU.badBranch], xPC);
            armAsm->Mov(a64::WRegister(EAX), xPC);
            armAsm->Str(a64::WRegister(EAX), PTR_MVU(microVU[mVU.index].badBranch));
			incPC(-4);
//		cJMP.SetTarget();
        armBind(&cJMP);
		return;
...
//		xMOV(gprT1, ptr32[&mVU.evilBranch]); // Branch Not Taken
        armAsm->Ldr(a64::WRegister(gprT1), PTR_MVU(microVU[mVU.index].evilBranch));
...
//		xMOV(ptr32[&mVU.evilevilBranch], gprT1);
        armAsm->Str(a64::WRegister(gprT1), PTR_MVU(microVU[mVU.index].evilevilBranch));
//		cJMP.SetTarget();
        armBind(&cJMP);
	}
	else
...
//		xMOV(gprT1, ptr32[&mVU.badBranch]); // Branch Not Taken
        armAsm->Ldr(a64::WRegister(gprT1), PTR_MVU(microVU[mVU.index].badBranch));
//		xADD(gprT1, 8); // We have already executed 1 instruction from the original branch
        armAsm->Add(gprT1, gprT1, 8);
//		xMOV(ptr32[&mVU.evilBranch], gprT1);
        armAsm->Str(a64::WRegister(gprT1), PTR_MVU(microVU[mVU.index].evilBranch));
//		cJMP.SetTarget();
        armBind(&cJMP);
		incPC(-2);
		if (mVUlow.branch >= 9)
...
//            xMOV(gprT1, ptr32[&mVU.VIbackup]);
            armAsm->Ldr(a64::WRegister(gprT1), PTR_MVU(microVU[mVU.index].VIbackup));
        }
        else {
            mVU.regAlloc->moveVIToGPR(gprT1, _Is_);
        }
...
//            xXOR(gprT1, ptr32[&mVU.VIbackup]);
            armAsm->Ldr(a64::WRegister(EAX), PTR_MVU(microVU[mVU.index].VIbackup));
            armAsm->Eor(gprT1, gprT1, EAX);
        }
        else
        {
...
//			xMOV(ptr32[&mVU.badBranch], gprT1);
            armAsm->Str(a64::WRegister(gprT1), PTR_MVU(microVU[mVU.index].badBranch));
		}
	}
}
