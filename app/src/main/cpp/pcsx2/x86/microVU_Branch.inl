...
//	xMOV(ptr32[&mVU.regs().VI[REG_STATUS_FLAG].UL], gprT1);
    armAsm->Str(a64::WRegister(gprT1), PTR_CPU(vuRegs[mVU.index].VI[REG_STATUS_FLAG].UL));
    mVUallocMFLAGa(mVU, gprT1, fMac);
    mVUallocCFLAGa(mVU, gprT2, fClip);
//	xMOV(ptr32[&mVU.regs().VI[REG_MAC_FLAG].UL], gprT1);
    armAsm->Str(a64::WRegister(gprT1), PTR_CPU(vuRegs[mVU.index].VI[REG_MAC_FLAG].UL));
//	xMOV(ptr32[&mVU.regs().VI[REG_CLIP_FLAG].UL], gprT2);
    armAsm->Str(a64::WRegister(gprT2), PTR_CPU(vuRegs[mVU.index].VI[REG_CLIP_FLAG].UL));
...
//		xMOV(ptr32[&mVU.regs().micro_statusflags[0]], gprF0);
        armAsm->Str(a64::WRegister(gprF0), PTR_CPU(vuRegs[mVU.index].micro_statusflags[0]));
//		xMOV(ptr32[&mVU.regs().micro_statusflags[1]], gprF1);
        armAsm->Str(a64::WRegister(gprF1), PTR_CPU(vuRegs[mVU.index].micro_statusflags[1]));
//		xMOV(ptr32[&mVU.regs().micro_statusflags[2]], gprF2);
        armAsm->Str(a64::WRegister(gprF2), PTR_CPU(vuRegs[mVU.index].micro_statusflags[2]));
//		xMOV(ptr32[&mVU.regs().micro_statusflags[3]], gprF3);
        armAsm->Str(a64::WRegister(gprF3), PTR_CPU(vuRegs[mVU.index].micro_statusflags[3]));
    }
    else // Flush flag instances
    {
//		xMOVDZX(xmmT1, ptr32[&mVU.regs().VI[REG_CLIP_FLAG].UL]);
        armAsm->Ldr(xmmT1.S(), PTR_CPU(vuRegs[mVU.index].VI[REG_CLIP_FLAG].UL));
...
//		xMOVDZX(xmmT1, ptr32[&mVU.regs().VI[REG_MAC_FLAG].UL]);
        armAsm->Ldr(xmmT1.S(), PTR_CPU(vuRegs[mVU.index].VI[REG_MAC_FLAG].UL));
//		xSHUF.PS(xmmT1, xmmT1, 0);
        armSHUFPS(xmmT1, xmmT1, 0);
//		xMOVAPS(ptr128[&mVU.regs().micro_macflags], xmmT1);
        armAsm->Str(xmmT1.Q(), PTR_CPU(vuRegs[mVU.index].micro_macflags));
...
//        xMOV(ptr32[&mVU.regs().nextBlockCycles], 0);
        armAsm->Str(a64::xzr, PTR_CPU(vuRegs[mVU.index].nextBlockCycles));
    }

//	xMOV(ptr32[&mVU.regs().VI[REG_TPC].UL], xPC);
    armAsm->Mov(a64::WRegister(EAX), xPC);
    armAsm->Str(a64::WRegister(EAX), PTR_CPU(vuRegs[mVU.index].VI[REG_TPC].UL));
...
//		xMOV(arg1regd, ptr32[&mVU.evilBranch]);
        armAsm->Ldr(a64::WRegister(EAX), PTR_MVU(microVU[mVU.index].evilBranch));
...
//        xMOV(arg1regd, ptr32[&mVU.branch]);
        armAsm->Ldr(a64::WRegister(EAX), PTR_MVU(microVU[mVU.index].branch));
    }
    if (doJumpCaching) {
...
//            xTEST(ptr32[&vu1Thread.vuFBRST], (isVU1 ? 0x400 : 0x4));
            armAsm->Tst(armLoad(armMemOperandPtr(&vu1Thread.vuFBRST)), (isVU1 ? 0x400 : 0x4));
        }
        else {
//            xTEST(ptr32[&VU0.VI[REG_FBRST].UL], (isVU1 ? 0x400 : 0x4));
            armAsm->Tst(armLoad(PTR_CPU(vuRegs[0].VI[REG_FBRST].UL)), (isVU1 ? 0x400 : 0x4));
        }
...
//            xTEST(ptr32[&vu1Thread.vuFBRST], (isVU1 ? 0x800 : 0x8));
            armAsm->Tst(armLoad(armMemOperandPtr(&vu1Thread.vuFBRST)), (isVU1 ? 0x800 : 0x8));
        }
        else {
//            xTEST(ptr32[&VU0.VI[REG_FBRST].UL], (isVU1 ? 0x800 : 0x8));
            armAsm->Tst(armLoad(PTR_CPU(vuRegs[0].VI[REG_FBRST].UL)), (isVU1 ? 0x800 : 0x8));
        }
//		xForwardJump32 eJMP(Jcc_Zero);
        a64::Label eJMP;
        armAsm->B(&eJMP, a64::Condition::eq);
...
//		xMOV(gprT1, ptr32[&mVU.branch]);
        armAsm->Ldr(a64::WRegister(gprT1), PTR_MVU(microVU[mVU.index].branch));
//		xMOV(ptr32[&mVU.regs().VI[REG_TPC].UL], gprT1);
        armAsm->Str(a64::WRegister(gprT1), PTR_CPU(vuRegs[mVU.index].VI[REG_TPC].UL));
//		xJMP(mVU.exitFunct);
        armEmitJmp(mVU.exitFunct);
//		eJMP.SetTarget();
        armBind(&eJMP);
