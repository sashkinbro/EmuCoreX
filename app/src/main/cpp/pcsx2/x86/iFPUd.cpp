...
//	xAND.PD(xRegisterSSE(absreg), ptr[&s_const.dbl_s_pos]);
    armAsm->And(regAbs.V16B(), regAbs.V16B(), armLoadPtrV(PTR_MVUCONST(s_const.dbl_s_pos)).V16B());
...
//	xPADD.D(xRegisterSSE(reg), ptr[s_const.one_exp]); //raise exponent
    armAsm->Add(regQ.V4S(), regQ.V4S(), armLoadPtrV(PTR_MVUCONST(s_const.one_exp)).V4S());
...
//	xAND.PS(xRegisterSSE(reg), ptr[s_const.neg]); //flush to zero
    armAsm->And(regQ.V16B(), regQ.V16B(), armLoadPtrV(PTR_MVUCONST(s_const.neg)).V16B());
...
//	xAND.PS(xRegisterSSE(EEREC_D), ptr[s_const.pos]);
    ...
    armAsm->And(regED.V16B(), regED.V16B(), armLoadPtrV(PTR_MVUCONST(s_const.pos)).V16B());
}
...
//	xAND.PS(xRegisterSSE(tempt), ptr[s_const.neg]);
    armAsm->And(regT.V16B(), regT.V16B(), armLoadPtrV(PTR_MVUCONST(s_const.neg)).V16B());
//	j8Ptr[5] = JMP8(0);
    armAsm->B(&j8Ptr5);
...
//	xAND.PS(xRegisterSSE(tempd), ptr[s_const.neg]);
    armAsm->And(regD.V16B(), regD.V16B(), armLoadPtrV(PTR_MVUCONST(s_const.neg)).V16B());
...
//	xPAND(xRegisterSSE(sreg), ptr[minmax_mask]);
    armAsm->And(regS.V16B(), regS.V16B(), armLoadPtrV(PTR_MVUCONST(minmax_mask)).V16B());
//	xPOR(xRegisterSSE(sreg), ptr[&minmax_mask[4]]);
    armAsm->Orr(regS.V16B(), regS.V16B(), armLoadPtrV(PTR_MVUCONST(minmax_mask[4])).V16B());
//	xPSHUF.D(xRegisterSSE(treg), xRegisterSSE(treg), 0x00);
    armPSHUFD(regT, regT, 0x00);
//	xPAND(xRegisterSSE(treg), ptr[minmax_mask]);
    armAsm->And(regT.V16B(), regT.V16B(), armLoadPtrV(PTR_MVUCONST(minmax_mask)).V16B());
...
//	xXOR.PS(xRegisterSSE(EEREC_D), ptr[&s_const.neg[0]]);
    armAsm->Eor(a64::QRegister(EEREC_D).V16B(), a64::QRegister(EEREC_D).V16B(), armLoadPtrV(PTR_MVUCONST(s_const.neg[0])).V16B());
}
...
//			xAND.PS(xRegisterSSE(EEREC_D), ptr[&s_const.pos[0]]); // Make EEREC_D Positive
            armAsm->And(regED.V16B(), regED.V16B(), armLoadPtrV(PTR_MVUCONST(s_const.pos[0])).V16B());
//		x86SetJ8(pjmp);
        armBind(&pjmp);
	}
	else
...
//		xAND.PS(xRegisterSSE(regt), ptr[&s_const.pos[0]]); // Make regt Positive
        armAsm->And(regT.V16B(), regT.V16B(), armLoadPtrV(PTR_MVUCONST(s_const.pos[0])).V16B());
//	x86SetJ8(pjmp2);
    armBind(&pjmp2);
