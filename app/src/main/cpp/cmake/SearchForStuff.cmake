...
if(ANDROID)
	# Android NDK provides pthreads in libc, no need to link -lpthread or -pthread.
	# Clearing this prevents CMake from adding it to target_link_libraries (like CMAKE_THREAD_LIBS_INIT).
	...
	# Some projects link against Threads::Threads. On Android, we make it an empty interface.
