...
function(get_git_version_info)
	...
	set(PCSX2_GIT_HASH "")
	if(ANDROID)
		# Android app builds may run from a sandbox user that cannot mark the
		# vendored EmuCoreX checkout as a safe Git directory. Avoid blocking CMake
		# regeneration on version metadata and fall back to static placeholders.
		set(PCSX2_GIT_REV "Android")
		set(PCSX2_GIT_TAG "")
		set(PCSX2_GIT_HASH "")
		set(PCSX2_GIT_DATE "")
