...
if(ANDROID)
	...
	elseif(CMAKE_ANDROID_ARCH_ABI STREQUAL "armeabi-v7a")
		set(CMAKE_HOST_SYSTEM_PROCESSOR "armv7")
...
elseif("${CMAKE_HOST_SYSTEM_PROCESSOR}" STREQUAL "arm64" OR "${CMAKE_HOST_SYSTEM_PROCESSOR}" STREQUAL "aarch64" OR
	...
	if(ANDROID)
		# Android ARM64 devices in our target range use 4 KB pages and 64-byte cache lines.
		# Without this override, generic ARCH_ARM64 defaults fall back to Apple-style 16 KB / 128 B,
		# which mismatches MTGS/MTVU queue layout assumptions at runtime.
