...
#define SDL_JAVA_PREFIX                               com_sbro_emucorex_core
...
//    register_methods(env, "com/sbro/emucorex/core/SDLActivity", SDLActivity_tab, SDL_arraysize(SDLActivity_tab));
//    register_methods(env, "com/sbro/emucorex/core/SDLInputConnection", SDLInputConnection_tab, SDL_arraysize(SDLInputConnection_tab));
//    register_methods(env, "com/sbro/emucorex/core/SDLAudioManager", SDLAudioManager_tab, SDL_arraysize(SDLAudioManager_tab));
    register_methods(env, "com/sbro/emucorex/core/utils/SDLControllerManager", SDLControllerManager_tab, SDL_arraysize(SDLControllerManager_tab));
    register_methods(env, "com/sbro/emucorex/core/hid/HIDDeviceManager", HIDDeviceManager_tab, SDL_arraysize(HIDDeviceManager_tab));
