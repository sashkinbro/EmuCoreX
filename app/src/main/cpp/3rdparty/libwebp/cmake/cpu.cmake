...
function(webp_check_compiler_flag WEBP_SIMD_FLAG ENABLE_SIMD)
  if(ANDROID AND CMAKE_ANDROID_ARCH_ABI STREQUAL "arm64-v8a")
    if(WEBP_SIMD_FLAG STREQUAL "NEON" AND ENABLE_SIMD)
      set(WEBP_HAVE_NEON 1 PARENT_SCOPE)
    else()
...
if(ANDROID AND CMAKE_ANDROID_ARCH_ABI STREQUAL "arm64-v8a")
  # arm64 Android builds only need NEON probing; desktop/x86 SIMD tests can
  # stall cross-compilation during CMake regeneration.
  set(WEBP_SIMD_FLAGS "NEON")
  set(WEBP_SIMD_FILE_EXTENSIONS "_neon.c")
  set(SIMD_ENABLE_FLAGS "")
  set(SIMD_DISABLE_FLAGS "")
endif()
