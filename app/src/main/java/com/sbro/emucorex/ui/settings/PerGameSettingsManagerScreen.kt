    ...
    Surface(
        ...
        Column(
            ...
            FlowRow(
                ...
                ProfileBadge(text = stringResource(R.string.game_settings_manager_upscale_badge, profile.upscaleMultiplier))
                ...
                Column(
                    ...
                    EditorSection(title = stringResource(R.string.game_settings_manager_section_profile)) {
                        ...
                        SliderRow(
                            ...
                            value = draft.upscaleMultiplier.toFloat(),
                            valueLabel = stringResource(R.string.game_settings_manager_upscale_badge, draft.upscaleMultiplier),
                            range = 1f..8f,
                            steps = 6,
                            onValueChange = { draft = draft.copy(upscaleMultiplier = it.toInt()) }
                        )
                    }
