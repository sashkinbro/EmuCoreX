...
data class PerGameSettings(
    ...
    val lightGunCursorEnabled: Boolean? = null,
...
private fun JSONObject.toPerGameSettings(): PerGameSettings {
    ...
    return PerGameSettings(
        ...
        lightGunCursorEnabled = if (has("lightGunCursorEnabled")) {
            optBoolean("lightGunCursorEnabled", true)
        } else {
            null
        },
...
private fun PerGameSettings.toJson(): JSONObject {
    return JSONObject().apply {
        ...
        if (shouldWrite("lightGunCursorEnabled")) {
            lightGunCursorEnabled?.let { put("lightGunCursorEnabled", it) }
        }
...
private fun OverlayControlLayout.toJson(): JSONObject {
    return JSONObject()
        ...
        .apply { secondaryActionId?.let { put("secondaryActionId", it) } }
}
