...
Item {
    Rectangle {
        ...
        ColumnLayout {
            ...
            Text { Layout.alignment: Qt.AlignHCenter; text: Emulator.running ? "Emulation session" : "Core adapter"; color: Theme.text; font.pixelSize: 28; font.weight: Font.Bold }
            Text { Layout.alignment: Qt.AlignHCenter; text: Emulator.statusText; color: Theme.textMuted; font.pixelSize: 14 }
            Text { Layout.alignment: Qt.AlignHCenter; text: Emulator.backendName; color: Theme.accentBright; font.pixelSize: 12 }
            RowLayout {
